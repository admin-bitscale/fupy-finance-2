...
import { ArrowRight, ArrowLeft, Check, Crown, Star, Zap, User, Mail, Eye, EyeOff } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!error) {
      // Usuario será redirecionado após confirmar email
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-primary/5 flex items-center justify-center p-4">
      ...
      >
        <Card className="shadow-2xl border-0 bg-card/95 backdrop-blur-lg">
          <CardHeader className="text-center space-y-8 pb-8 pt-10">
            <motion.div 
